...
const RegisterScreen = ({ navigation, route }) => {
  ...
  const handleSendOtp = async () => {
    ...
    setOtpState(
      response.success ? REQUEST_STATES.SUCCESS : REQUEST_STATES.ERROR,
    );
      ...
      <View style={styles.form}>
        ...
        <View>
          ...
          <Pressable
            ...
            disabled={otpState === REQUEST_STATES.LOADING}
            style={styles.sendOtp}
          >
            <MyText style={styles.sendOtpText}>
              {otpState === REQUEST_STATES.LOADING ? "Sending..." : "Send OTP"}
            </MyText>
          </Pressable>
        </View>
        <AppInput
        ...
        >
          ...
          <MyText style={styles.termsText}>
            I agree to the{" "}
            <MyText style={styles.termsLink}>Terms & Conditions</MyText>
          </MyText>
        </Pressable>
        {errors.terms ? (
          <MyText style={styles.termsError}>{errors.terms}</MyText>
        ) : null}
